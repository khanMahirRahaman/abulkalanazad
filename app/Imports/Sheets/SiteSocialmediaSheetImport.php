...
class SiteSocialmediaSheetImport implements ToCollection, WithEvents, SkipsEmptyRows, WithHeadingRow
{
    ...
    public static function beforeSheet(BeforeSheet $event)
    {
        ...
        DB::table('site_socialmedia')->delete();
    ...
    public function collection(Collection $rows)
    {
        foreach($rows as $row)
        {
            DB::table('site_socialmedia')->insert([
                'id'             => $row['id'],
