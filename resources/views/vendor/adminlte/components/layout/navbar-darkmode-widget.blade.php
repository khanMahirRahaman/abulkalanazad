...
<script>
    ...
    $(() => {
        ...
        const topNav = document.getElementsByClassName('main-header')[0];
        ...
        widget.addEventListener('click', () => {
            ...
            const classes = ['navbar-white','navbar-light'];
            classes.forEach(c => {
                if (topNav.classList.contains(c)) {
                    topNav.classList.remove(c);
                } else {
                    topNav.classList.add(c);
                }
            });

            topNav.classList.toggle('navbar-black');
            topNav.classList.toggle('navbar-dark');
