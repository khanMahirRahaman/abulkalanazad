...
@section('title', __('page.title_addnew_page'))

@section('content_header')
    <x-breadcrumbs title="{{ __('page.title_addnew_page') }}" currentActive="{{ __('general.breadcrumb_add_new') }}" :addLink="[route('pages.index') => __('page.title_pages')]"/>
@stop
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="card card-default">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <select id="language" name="language" class="select2" data-placeholder="{{ __('page.placeholder_language') }}" style="width: 100%;">
