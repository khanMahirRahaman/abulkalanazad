...
@section('title', __('adminlte.login') .' - '. strip_tags(config('adminlte.logo')))

@section('auth_box_msg', __('adminlte.login_message'))
...
@section('auth_body')
    <form action="{{ $login_url }}" method="post">
        ...
        <div class="input-group mb-3">
            <input type="text" name="username" class="form-control{{ $errors->has('username') ? ' is-invalid' : '' }}" placeholder="{{ __('adminlte.username_or_email') }}" autofocus>
